...
<table  class="table table-hover">
  ...
  formurario_permiso fp, personal p, tabla_central tb, cargos car, areas a WHERE fp.id_formurario_permiso=tb.id_permisos and tb.id_personal=p.id_personal and fp.fk_nombre_usuario=p.id_personal and p.fk_cargo=car.id_cargos and car.fk_id_areas= a.id_areas ORDER by a.unidad_administrador  asc limit $desde,$por_pagina; ";
