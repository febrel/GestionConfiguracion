...
<body>
    ...
    <section id="container">
      ...
      <form action="lista_re_bus.php" method="get" class="form_search">
...
/*=============================Recuperacion de datos=================================*/
        $query = mysqli_query($conexion, "SELECT  p.id_personal, p.nombres,p.nro_identificacion, p.correo, p.usuario,c.nombre_cargo, r.nombre_Rol FROM personal p,
            ...
            p.fk_cargo=c.id_cargos AND estado =1 and  p.id_personal!=1 order by nombres asc
        ...
        if($result > 0){
            while($data =mysqli_fetch_array($query) ){
                ...
                <tr>
                 ...
                 <td>
                    <a href="reportes/reporte_individual.php?id=<?php echo $data['id_personal']; ?>"  target="_blank"> <i class="reporte fas fa-file-alt"></i> </a>               
                </td>     
            </tr>            
            <?php
        }
